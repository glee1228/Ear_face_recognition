...
#재생할 파일 
#VIDEO_FILE_PATH = '0'
left_ear_cascade = cv2.CascadeClassifier('./haarcascades/update_haarcascade_leftear.xml')
# 동영상 파일 열기
...
while(True):
    ...
    for (x, y, w, h) in left_ear:
        ...
        cv2.rectangle(frame, (x-7, y-7), (x + w+10, y + h+7), (0, 255, 0), 1)
